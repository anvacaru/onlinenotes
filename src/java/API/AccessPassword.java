 ...
 * @author Andrei
 */
@WebServlet(urlPatterns = {"/AccessPassword"})
public class AccessPassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection conn = dbRes.getConnection();
             PreparedStatement ps = conn.prepareStatement(" SELECT * FROM notes WHERE url = ? and aPwd =?");) {
